...
def test_deadline_enters_bounded_finalization_only_in_same_session(tmp_path, monkeypatch):
    ...
    assert "TYCHE_ARENA_FINALIZATION_REASON" not in calls[1][0]
...
@pytest.mark.parametrize("exc,expected", [
    ...
    (RuntimeError("TYCHE shared runner stopped: repeated_worker_no_progress"),
     ("runtime_error", "unchanged_exit_limit")),
    (RuntimeError("TYCHE shared runner stopped: finalization_timeout"),
     ("timeout", "deadline_or_idle_timeout")),
    (RuntimeError("TYCHE shared runner stopped: host_deadline"),
     ("timeout", "deadline_or_idle_timeout")),
